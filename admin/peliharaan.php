...
$data_hewan = select("SELECT pets.id, pets.nama_hewan, pets.jenis, pets.ras,
pets.jenis_kelamin, pets.tanggal_lahir, owners.nama AS nama_pemilik
FROM pets
LEFT JOIN owners 
ON pets.id_owner = owners.id ");
?>
...
<html lang="en">
   ...
   <body class="sidebar-main-active right-column-fixed">
      ...
      <div class="wrapper">
       ...
       <?php include '../admin/template_admin/navbar.php'; ?>
         ...
         <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Peliharaan</h1>

            
              <a href="peliharaantambah.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            ...
            <div class="container-fluid">
                  ...
                  <div class="col-sm-12">
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           <p>Table Ini Berisi Data Data Hewan Peliharaan Yang Ada Di Tempat Kami. Selamat Membaca Dan Melihat Data Hewan Peliharaan Kami.</p>
               ...
               <tbody>
            <?php $ids =       1; ?>
                        <?php foreach ($data_hewan as $hewan): ?>
                            <tr>
                                <td class="text-center"><?= $ids++; ?></td>
                                <td class="text-center"><?= $hewan['nama_pemilik']; ?></td>
                                <td class="text-center"><?= $hewan['nama_hewan']; ?></td>
                                <td class="text-center"><?= $hewan['jenis']; ?></td>
                                <td class="text-center"><?= $hewan['ras']; ?></td>
                                <td class="text-center"><?= $hewan['jenis_kelamin']; ?></td>
                                <td class="text-center"><?= $hewan['tanggal_lahir']; ?></td>
                                <td width="20%" class="text-center">
                                    <a href="peliharaanedit.php?id=<?= $hewan['id']; ?>" class="btn btn-info">
                                    <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="peliharaandelete.php?id=<?= $hewan['id']; ?>" class="btn btn-danger"  onclick="return confirmDelete();" title="delete">
    ...
    function confirmDelete() {
      return confirm("Apakah Anda yakin ingin menghapus data Peliharaan ini?");
    }
  </script>

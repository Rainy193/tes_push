       ...
       <?php include '../admin/template_admin/navbar.php'; ?>
         ...
         <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dokter</h1>
              ...
              <a href="doktertambah.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                  ...
                  <div class="col-sm-12">
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           <p>Table Ini Berisi Data Data Dokter Hewan Peliharaan Yang Berada Yang Ada Di Tempat Kami. Selamat Membaca Dan Melihat Data Dokter Hewan Peliharaan Kami.</p>
            ...
            <?php $ids =       1; ?>
                        <?php foreach ($data_dokter as $dokter): ?>
                            <tr>
                                ...
                                <td class="text-center"><?= $dokter['kontek']; ?></td>
                                <td class="text-center"><?= $dokter['alamat']; ?></td>               
                                <td width="20%" class="text-center">
                                    <a href="dokteredit.php?id=<?= $dokter['id']; ?>" class="btn btn-info">
                                    <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="dokterdelete.php?id=<?= $dokter['id']; ?>" class="btn btn-danger"  onclick="return confirmDelete();" title="delete">

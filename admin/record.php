...
$data_kesehatan = select("SELECT 
            health_records.id,    
            health_records.tanggal_periksa, 
            health_records.catatan, 
            health_records.vaksinasi, 
            health_records.nama_vaksin, 
            pets.nama_hewan AS pet_name, 
            vets.nama AS vet_name
          FROM 
            health_records
          LEFT JOIN pets 
          ON health_records.id_pet = pets.id
          LEFT JOIN 
          vets ON health_records.id_dokter = vets.id;");
...
<html lang="en">
   <head>
      ...
      <title>Tabel | Catatan Kesehatan</title>
      <!-- Favicon -->
   ...
   <body class="sidebar-main-active right-column-fixed">
      ...
      <div class="wrapper">
       ...
       <?php include '../admin/template_admin/navbar.php'; ?>
         ...
         <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Catatan Kesehatan</h1>

            
              <a href="recordtambah.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            ...
            <div class="container-fluid">
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Data Catatan Kesehatan Hewan</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
                           <p>Table Ini Berisi Catatan Catatan Kesehatan Hewan Peliharaan Yang Berada Yang Ada Di Tempat Kami. Selamat Membaca Dan Melihat Catatan Kesehatan Hewan Peliharaan Kami.</p>
               ...
               <tbody>
            <?php $ids = 1; ?>
                        <?php foreach ($data_kesehatan as $catatan): ?>
                            <tr>
                                <td class="text-center"><?= $ids++; ?></td>
                                <td class="text-center"><?= $catatan['pet_name']; ?></td>
                                <td class="text-center"><?= $catatan['vet_name']; ?></td>
                                <td class="text-center"><?= $catatan['tanggal_periksa']; ?></td>
                                <td class="text-center"><?= $catatan['catatan']; ?></td>
                                <td class="text-center"><?= $catatan['vaksinasi']; ?></td>               
                                <td class="text-center"><?= $catatan['nama_vaksin']; ?></td>               
                                <td width="20%" class="text-center">
                                    <a href="recordedit.php?id=<?= $catatan['id']; ?>" class="btn btn-info">
                                    <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="recorddelete.php?id=<?= $catatan['id']; ?>" class="btn btn-danger"  onclick="return confirmDelete();" title="delete">
    ...
    function confirmDelete() {
      return confirm("Apakah Anda yakin ingin menghapus data jurusan ini?");
    }
  </script>
